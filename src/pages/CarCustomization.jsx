      ...
      <div className="performance-bars mb-6">
        ...
        <div className="mb-4">
          ...
          <div className="w-full bg-gray-700 rounded-full h-6">
            <div className="bg-red-600 h-6 rounded-full transition-all duration-500 ease-in-out" style={{ width: `${speed}%` }}></div>
          </div>
        </div>
        <div className="mb-4">
          <label className="block mb-1">Aceleração</label>
          <div className="w-full bg-gray-700 rounded-full h-6">
            <div className="bg-red-600 h-6 rounded-full transition-all duration-500 ease-in-out" style={{ width: `${acceleration}%` }}></div>
          </div>
        </div>
        <div>
          <label className="block mb-1">Controle</label>
          <div className="w-full bg-gray-700 rounded-full h-6">
            <div className="bg-red-600 h-6 rounded-full transition-all duration-500 ease-in-out" style={{ width: `${control}%` }}></div>
          </div>
        </div>
      </div>
      <ArrowChatButton />
