        ...
        {!showResult ? (
          <div>
            ...
            <div className="flex justify-between">
              <button
                ...
                className="w-1/2 bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-700 mr-2"
              >
                Próxima Pergunta
              </button>
              <button
                onClick={handleStopQuiz}
                className="w-1/2 bg-yellow-500 text-white py-2 px-4 rounded-lg hover:bg-yellow-700"
              >
                Parar Quiz
              </button>
            </div>
          ...
          <div className="text-center text-white">
            ...
            <button
              ...
              className="w-full bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-700"
            >
              Reiniciar Quiz
            </button>
          </div>
